...
if cap_stages:
    ...
    with left:
        ...
        fig.update_layout(height=245,margin=dict(l=5,r=65,t=10,b=20),
    ...
    with right:
        ...
        for e in cap_stages:
            ...
            rows.append(row)
        d=pd.DataFrame(rows)
        for col in d.columns[1:]: d[col]=d[col].map(lambda x:n(x))
...
if focus=="Todos":
    ...
    with c1:
        ...
        fig.update_layout(height=300,margin=dict(l=5,r=5,t=30,b=15),showlegend=False,
    ...
    with c1:
        ...
        fig.update_layout(height=310,margin=dict(l=5,r=5,t=25,b=15),showlegend=False,
    ...
    with c2:
        ...
        fig.update_layout(height=310,margin=dict(l=5,r=5,t=20,b=15),
...
with r1:
    ...
    fig.update_layout(height=190,margin=dict(l=5,r=20,t=30,b=20),
...
with s1:
    ...
    fig.update_layout(height=320,margin=dict(l=5,r=5,t=30,b=15),showlegend=False,
