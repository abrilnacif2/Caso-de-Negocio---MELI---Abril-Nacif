    ...
    with right:
        ...
        for e in cap_rows:
            ...
            for s in ["5x","5,5x","6x"]:
                v=cap_values[s][e]
                html_cap += f"""
                <td style="padding:20px 14px;text-align:center;border-top:1px solid #E5E5EA;background:{cap_tints[s]};">
                  <div style="font-size:20px;font-weight:850;color:#111;">{v:,}</div>
                  <div style="font-size:10px;font-weight:500;color:#6E6E73;margin-top:3px;">paquetes / ruta</div>
                </td>
                """
            html_cap += "</tr>"
